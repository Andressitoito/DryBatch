...
const Modal = ({ isOpen, onClose, containers = [], latestContainers = [], addMeasurement, productId }) => {
  ...
  >
    <div
      className="bg-white p-6 rounded-lg w-full max-w-md md:max-w-lg lg:max-w-2xl relative overflow-y-auto max-h-[80vh] scrollbar scrollbar-thumb-gray-400 scrollbar-track-gray-200"
    >
